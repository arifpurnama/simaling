...
public class ParseContent {
   ...
   public String getErrorMessage(String response) {
        ...
        return "Koneksi tidak ditemukan";
    }
              ...
              JSONArray dataArray = jsonObject.getJSONArray("data");
                for (int i = 0; i < dataArray.length(); i++) {
                   ...
                   JSONObject dataobj = dataArray.getJSONObject(i);
                    preferenceHelper.putNoktp(dataobj.getString(Constants.Params.NOKTP));
                    preferenceHelper.putNotelp(dataobj.getString(Constants.Params.NOTELP));
              }
          }
        } catch (JSONException e) {
            e.printStackTrace();
